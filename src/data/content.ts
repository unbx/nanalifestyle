export const siteConfig = {
  ...
  socials: {
    ...
    linkedin: "https://www.linkedin.com/in/seannana/",
    instagram: "https://instagram.com/seannana",
  },
};
...
export const creativeWork = {
  ...
  stats: [
    ...
    { value: "2", label: "Continental Tours" },
  ...
  releases: [
    {
      ...
      type: "Album",
      year: "2021",
      image: "/assets/placeholder-release.jpg",
      spotifyUrl: "https://open.spotify.com/artist/53htGvuREf9YT5LYk5HEvb",
    },
    {
      title: "Pool Haus EP",
      type: "EP",
      year: "2020",
      artist: "MIKNNA x SATICA",
      image: "/assets/placeholder-release.jpg",
      note: "3M+ streams worldwide",
    },
    {
      title: "50|50 (Side A)",
      type: "EP",
  ...
  videos: [
    ...
    },
    {
      ...
      youtubeId: "placeholder",
      year: "2017",
      note: "Directed, edited, produced & mixed by Ken Nana",
    },
  ],
};
  ...
  roles: [
    {
      ...
      products: [
        {
          name: "OpenPage",
          tagline: "Universal Avatar Platform",
          url: "https://op.xyz",
          description: "Turning followers into superfans. Verify fans, prove engagement, reward loyalty.",
        },
        {
          name: "Doppel",
          tagline: "AI-Agent Built 3D Spaces",
          url: "https://doppel.fun",
          description: "Intersection of 3D, blockchain, and AI agents.",
        },
      ],
    },
    {
      company: "Other Space FM",
      title: "Founder",
...
export const experienceWork = {
  title: "Experience",
  subtitle: "Enterprise L&D & Enablement",
  description:
    "17+ years designing learning experiences and scaling enablement programs at some of the most recognized brands in tech.",
  roles: [
    {
      company: "Enjoy Inc.",
  ...
  education: {
    ...
    degree: "B.A. in Art, emphasis in Multimedia",
    year: "2007",
  },
};
